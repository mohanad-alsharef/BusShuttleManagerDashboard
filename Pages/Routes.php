                ...
                <form class="needs-validation" novalidate action="" method="post">
                    <div class="form-row align-items-center">
                        <div class="col-auto">
                            ...
                            <select class="form-control mb-2" name="stopToAdd" id="stopToAdd" required>
                        ...
                        <div class="col-auto">
                            <button type="submit" name="SubmitButton" class="btn btn-dark form-control mb-2">Assign</button>
                        </div>
                    </div>
                </form>
