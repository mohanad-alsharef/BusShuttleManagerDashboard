 ...
 * Licensed undTWERTWERTer MIT (https://github.com/markcell/jQuery-Tabledit/blob/master/LICENSE)
 */
    ...
    $.fn.Tabledit = function(options) {
        ...
        var defaults = {
            ...
            buttons: {
                edit: {
                    ...
                    html: '<i class="far fa-edit" title="Edit Item"></i>',
                    action: "edit"
                  },
                  delete: {
                    class: "btn btn-sm btn-dark",
                    html: '<i class="fa fa-trash" aria-hidden="true" title="Delete Item"></i>',
                    action: "delete"
                  },
                  save: {
        ...
        var Delete = {
            ...
            submit: function(td) {
                ...
                $(td).parent('tr').addClass('table-danger');
                // Hide table row.
            ...
            restore: function(td) {
                ...
                $(td).parent('tr').removeClass('table-danger');
                // Hide table row.
        ...
        if (settings.editButton) {
             ...
             * @param {object} event
             */
            $table.on(settings.eventType, 'tr:not(.table-danger) td.tabledit-view-mode', function(event) {
                if (event.handled !== true) {
                    event.preventDefault();
